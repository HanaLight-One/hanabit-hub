...
test("React 뉴스 검수실 화면과 승인 스크립트를 제공한다", async () => {
  ...
  try {
    ...
    assert.equal(body.includes('/news/app.js?v=20260804-editor-note-bottom'), true);
    assert.equal(body.includes('/news/styles.css?v=20260804-editor-note-bottom'), true);
