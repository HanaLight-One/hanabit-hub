...
var e = Object.create, t = Object.defineProperty, n = Object.getOwnPropertyDescriptor, r = Object.getOwnPropertyNames, i = Object.getPrototypeOf, a = Object.prototype.hasOwnProperty, o = (e, t) => () => (t || (e((t = { exports: {} }).exports, t), e = null), t.exports), s = (e, i, o, s) => {
	...
	function xi(e, t, n, r, a, o) {
		...
		if (r = e, typeof e == "function") vi(e) && (s = 1);
			...
			case w: return e = _i(19, n, t, a), e.elementType = w, e.lanes = o, e;
			default:
	...
	t.exports = _();
})), y = /* @__PURE__ */ c(u(), 1), b = g(), x = v(), ee = 50, S = 101;
function C() {
	return {
		id: null,
		headText: "잡담",
...
async function te(e, t = {}) {
	...
	if (!n.ok) throw Error(r.error ?? "요청을 완료하지 못했어요.");
	return r;
}
function w(e) {
...
function ne(e) {
	return (e.blocks ?? []).filter((e) => e.type === "image");
}
function T(e) {
	return (e.blocks ?? []).filter((e) => e.type === "text").map((e) => e.text).join("\n\n");
}
function re(e) {
	return Array.isArray(e?.blocks) && e.blocks.length ? e : {
		...e,
		blocks: [...(e?.images ?? []).map((e) => ({
			type: "image",
			...e
		})), {
			type: "text",
...
function ie(e) {
	return JSON.stringify({
		headText: e.headText,
		title: e.title,
		blocks: e.blocks.map((e) => e.type === "text" ? {
			type: "text",
			text: e.text
		} : {
			type: "image",
...
function oe() {
	let [e, t] = (0, y.useState)(!1), [n, r] = (0, y.useState)(!1), [i, a] = (0, y.useState)(!1), [o, s] = (0, y.useState)([]), [c, l] = (0, y.useState)([]), [u, d] = (0, y.useState)([]), [f, p] = (0, y.useState)(C), [m, h] = (0, y.useState)(null), [g, _] = (0, y.useState)(""), [v, b] = (0, y.useState)("편집실을 준비하는 중이에요."), [oe, le] = (0, y.useState)(""), [E, D] = (0, y.useState)(!1), ue = (0, y.useRef)(""), de = (0, y.useMemo)(() => new Set(ne(f).map(w)), [f.blocks]);
	async function fe() {
		try {
			let [e, t] = await Promise.all([te("/api/dc/composer", { cache: "no-store" }), te("/api/images", { cache: "no-store" })]);
			if (r(e.enabled), a(e.publisherReady), s(e.headTexts ?? []), d(e.uploads ?? []), l((t.images ?? []).map((e) => ({
				...
				p(t), ue.current = ie(t), le("저장된 초안을 복구했어요.");
			}
	...
	(0, y.useEffect)(() => {
		...
		if (!E || !n || g || f.publication || ie(f) === ue.current) return;
		if (!f.title.trim() && !T(f).trim() && ne(f).length === 0) {
			le("");
			return;
		}
		le("자동 저장 대기 중…");
		let e = setTimeout(async () => {
			...
			try {
				let e = await ae(f);
				ue.current = ie(e), p((t) => t.id ? t : {
					...t,
					id: e.id
				}), le("자동 저장됨");
			} catch {
				le("자동 저장 실패 · 미리보기 버튼으로 다시 저장해 주세요.");
			}
		}, 900);
	...
	function pe(e) {
		if (!n || g) return;
		let t = w(e);
		h(null), p((n) => ne(n).some((e) => w(e) === t) ? {
			...n,
			blocks: n.blocks.filter((e) => e.type !== "image" || w(e) !== t)
		} : ne(n).length >= ee ? (b(`이미지는 최대 ${ee}장까지 선택할 수 있어요.`), n) : {
			...n,
			blocks: [...n.blocks, {
				type: "image",
				...e
	...
	function O(e, t) {
		p((n) => {
			let r = e + t;
			if (r < 0 || r >= n.blocks.length) return n;
			let i = [...n.blocks];
			return [i[e], i[r]] = [i[r], i[e]], {
				...n,
				blocks: i
			};
		}), h(null);
	...
	async function ge(e) {
		let t = [...e.target.files].slice(0, ee);
		if (t.length) {
			_("upload");
			try {
				let e = [];
				for (let n of t) {
					let t = await te("/api/dc/uploads", {
						method: "POST",
						headers: {
							"content-type": n.type,
							"x-upload-filename": encodeURIComponent(n.name)
						},
						body: n
					});
					e.push(t);
				}
				d((t) => [...e, ...t.filter((t) => !e.some((e) => e.id === t.id))]), b(`${e.length}장 업로드했어요.`);
			} catch (e) {
				b(e.message);
			} finally {
				_(""), e.target.value = "";
	...
	async function _e(e) {
		if (e) {
			if (de.has(`upload:${e.id}`)) {
				b("선택 중인 업로드 이미지는 첨부에서 먼저 빼주세요.");
				return;
			}
			if (confirm(`'${e.name}' 업로드 파일을 서버에서 삭제할까요?`)) {
				_("delete-upload");
				try {
					await te(`/api/dc/uploads/${e.id}`, {
						method: "DELETE",
						headers: { "content-type": "application/json" },
						body: JSON.stringify({ confirmation: "delete-dc-upload" })
					}), d((t) => t.filter((t) => t.id !== e.id)), b("업로드 파일을 삭제했어요.");
				} catch (e) {
					b(e.message);
				} finally {
					_("");
	...
	function ve() {
		p(C()), ue.current = "", le(""), h(null), b("새 원고를 시작했어요.");
	}
	async function ye() {
		_("save");
		try {
			let e = await ae(f);
			ue.current = ie(e), p(re(e));
			let t = await te(`/api/dc/drafts/${e.id}/preview`, { cache: "no-store" });
	...
	async function be() {
		if (!(!m?.canPublish || !f.id) && confirm("이 원고를 챗GPT 갤러리에 실제로 게시할까요?\n제출 후 결과가 애매하면 자동으로 다시 시도하지 않아요.")) {
			_("publish");
			try {
				let e = await te(`/api/dc/drafts/${f.id}/publish`, {
					method: "POST",
					headers: { "content-type": "application/json" },
				...
				p(e), h((e) => ({
					...e,
					canPublish: !1
				})), b(e.publication?.status === "posted" ? "DC 게시가 완료됐어요." : "게시 결과가 불명확해 자동 재시도하지 않았어요.");
			} catch (e) {
				b(e.message);
			} finally {
				_("");
	...
	return /* @__PURE__ */ (0, x.jsxs)(x.Fragment, { children: [/* @__PURE__ */ (0, x.jsxs)("header", {
		className: "topbar",
		children: [/* @__PURE__ */ (0, x.jsxs)("a", {
			...
			children: [/* @__PURE__ */ (0, x.jsx)("span", {
				...
				children: "H"
			}), /* @__PURE__ */ (0, x.jsxs)("span", { children: ["HANABIT ", /* @__PURE__ */ (0, x.jsx)("b", { children: "DC" })] })]
		}), /* @__PURE__ */ (0, x.jsx)("span", {
			className: `runtime ${i ? "online" : ""}`,
			children: i ? "게시자 연결됨" : "게시자 확인 필요"
		})]
	}), /* @__PURE__ */ (0, x.jsxs)("main", { children: [/* @__PURE__ */ (0, x.jsxs)("section", {
		className: "hero",
		children: [
			/* @__PURE__ */ (0, x.jsx)("p", {
				className: "eyebrow",
				children: "OWNER ONLY · COMPOSER"
			}),
			/* @__PURE__ */ (0, x.jsxs)("h1", { children: [
				"골라서 쓰고,",
				/* @__PURE__ */ (0, x.jsx)("br", {}),
				/* @__PURE__ */ (0, x.jsx)("em", { children: "바로 게시." })
			] }),
			/* @__PURE__ */ (0, x.jsx)("p", { children: v })
		]
		...
		children: [
			/* @__PURE__ */ (0, x.jsxs)("section", {
				...
				children: [
					...
					/* @__PURE__ */ (0, x.jsx)("h2", { children: "원고 작성" }),
					/* @__PURE__ */ (0, x.jsxs)("label", { children: ["말머리", /* @__PURE__ */ (0, x.jsx)("select", {
						value: f.headText,
						disabled: !n || g,
						onChange: (e) => {
							p({
								...f,
								headText: e.target.value
							}), h(null);
						},
						children: o.map((e) => /* @__PURE__ */ (0, x.jsx)("option", { children: e }, e))
					})] }),
					/* @__PURE__ */ (0, x.jsxs)("label", { children: [
						"제목 ",
						/* @__PURE__ */ (0, x.jsxs)("span", { children: [[...f.title].length, "/80"] }),
					...
					/* @__PURE__ */ (0, x.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, x.jsx)("span", { children: "본문·이미지 블록" }), /* @__PURE__ */ (0, x.jsxs)("span", { children: [T(f).length.toLocaleString(), "/20,000"] })]
					}),
					/* @__PURE__ */ (0, x.jsx)("div", {
						className: "content-block-editor",
						children: f.blocks.map((e, t) => e.type === "text" ? /* @__PURE__ */ (0, x.jsxs)("article", {
							className: "content-block text-block",
							children: [/* @__PURE__ */ (0, x.jsxs)("header", { children: [/* @__PURE__ */ (0, x.jsxs)("strong", { children: ["텍스트 ", String(t + 1).padStart(2, "0")] }), /* @__PURE__ */ (0, x.jsx)(se, {
								index: t,
								length: f.blocks.length,
								busy: g,
								move: O,
								remove: he
								...
								maxLength: 2e4,
								disabled: !n || g,
								onChange: (e) => me(t, e.target.value),
								placeholder: "이 위치에 들어갈 글을 작성해 주세요"
							})]
						}, `text-${t}`) : /* @__PURE__ */ (0, x.jsxs)("article", {
							...
							children: [
								...
								/* @__PURE__ */ (0, x.jsxs)("div", { children: [/* @__PURE__ */ (0, x.jsxs)("strong", { children: ["이미지 ", String(t + 1).padStart(2, "0")] }), /* @__PURE__ */ (0, x.jsx)("span", { children: e.name })] }),
								/* @__PURE__ */ (0, x.jsx)(se, {
									index: t,
									length: f.blocks.length,
									busy: g,
					...
					/* @__PURE__ */ (0, x.jsx)("button", {
						...
						type: "button",
						disabled: !n || g || f.blocks.length >= S,
						onClick: k,
						children: "＋ 텍스트 블록 추가"
					}),
					/* @__PURE__ */ (0, x.jsx)("p", {
						className: `autosave-state ${oe.includes("실패") ? "failed" : ""}`,
						"aria-live": "polite",
						children: oe || "내용을 입력하면 서버 초안에 자동 저장해요."
					})
				]
			}),
			/* @__PURE__ */ (0, x.jsxs)("section", {
				...
				children: [
					/* @__PURE__ */ (0, x.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, x.jsxs)("div", { children: [/* @__PURE__ */ (0, x.jsx)("p", {
							className: "section-label",
							children: "02 · PICK"
						}), /* @__PURE__ */ (0, x.jsx)("h2", { children: "이미지 보관함" })] }), /* @__PURE__ */ (0, x.jsxs)("label", {
							className: "upload-button",
							children: [g === "upload" ? "업로드 중…" : "이미지 업로드", /* @__PURE__ */ (0, x.jsx)("input", {
								type: "file",
					...
					/* @__PURE__ */ (0, x.jsx)(ce, {
						...
						selectedKeys: de,
						toggle: pe,
						onDelete: (e) => _e(u.find((t) => t.id === e.sourceId)),
			...
			/* @__PURE__ */ (0, x.jsxs)("aside", {
				...
				children: [
					...
					/* @__PURE__ */ (0, x.jsx)("h2", { children: "게시 순서" }),
					/* @__PURE__ */ (0, x.jsx)("div", {
						className: "layout-summary",
						children: f.blocks.map((e, t) => e.type === "text" ? /* @__PURE__ */ (0, x.jsxs)("article", { children: [/* @__PURE__ */ (0, x.jsxs)("b", { children: [String(t + 1).padStart(2, "0"), " · TEXT"] }), /* @__PURE__ */ (0, x.jsx)("span", { children: e.text.trim().slice(0, 54) || "빈 텍스트 블록" })] }, `summary-text-${t}`) : /* @__PURE__ */ (0, x.jsxs)("article", { children: [/* @__PURE__ */ (0, x.jsx)("img", {
							src: e.contentUrl,
							alt: ""
						}), /* @__PURE__ */ (0, x.jsxs)("div", { children: [/* @__PURE__ */ (0, x.jsxs)("b", { children: [String(t + 1).padStart(2, "0"), " · IMAGE"] }), /* @__PURE__ */ (0, x.jsx)("span", { children: e.name })] })] }, `summary-${w(e)}`))
					}),
					/* @__PURE__ */ (0, x.jsx)("button", {
					...
					m && /* @__PURE__ */ (0, x.jsxs)("section", {
						...
						children: [
							/* @__PURE__ */ (0, x.jsx)("span", { children: m.draft.headText }),
							/* @__PURE__ */ (0, x.jsx)("h3", { children: m.draft.title || "제목 없음" }),
							/* @__PURE__ */ (0, x.jsx)("div", {
								className: "copy-layout",
								children: m.draft.blocks.map((e, t) => e.type === "text" ? /* @__PURE__ */ (0, x.jsx)("pre", { children: e.text || "(빈 텍스트)" }, `preview-text-${t}`) : /* @__PURE__ */ (0, x.jsxs)("figure", { children: [/* @__PURE__ */ (0, x.jsx)("img", {
									src: e.contentUrl,
									alt: ""
								}), /* @__PURE__ */ (0, x.jsx)("figcaption", { children: e.name })] }, `preview-${w(e)}`))
							}),
							/* @__PURE__ */ (0, x.jsxs)("p", { children: [
								"텍스트와 이미지가 위 순서 그대로 들어가요 · 이미지 ",
								m.draft.images.length,
								"장"
							] }),
							m.preflight.errors.length > 0 && /* @__PURE__ */ (0, x.jsx)("ul", { children: m.preflight.errors.map((e) => /* @__PURE__ */ (0, x.jsx)("li", { children: e }, e)) }),
							/* @__PURE__ */ (0, x.jsx)("button", {
					...
					f.publication?.status === "posted" && /* @__PURE__ */ (0, x.jsx)("a", {
						className: "receipt",
...
function se({ index: e, length: t, busy: n, move: r, remove: i }) {
	return /* @__PURE__ */ (0, x.jsxs)("nav", { children: [
		/* @__PURE__ */ (0, x.jsx)("button", {
			type: "button",
			"aria-label": "블록 위로",
			onClick: () => r(e, -1),
...
function ce({ images: e, selectedKeys: t, toggle: n, onDelete: r = null, empty: i }) {
	return e.length ? /* @__PURE__ */ (0, x.jsx)("div", {
		className: "image-grid",
		children: e.map((e) => /* @__PURE__ */ (0, x.jsxs)("article", {
			className: t.has(w(e)) ? "selected" : "",
			children: [/* @__PURE__ */ (0, x.jsxs)("button", {
				...
				children: [
					...
					/* @__PURE__ */ (0, x.jsx)("span", { children: e.name }),
					/* @__PURE__ */ (0, x.jsx)("small", { children: t.has(w(e)) ? "선택됨" : e.meta })
				]
			}), r && /* @__PURE__ */ (0, x.jsx)("button", {
				type: "button",
				className: "upload-delete",
				"aria-label": `${e.name} 업로드 삭제`,
				onClick: () => r(e),
				children: "×"
			})]
		}, w(e)))
...
(0, b.createRoot)(document.querySelector("#dc-root")).render(/* @__PURE__ */ (0, x.jsx)(oe, {}));
//#endregion
