...
function ee(e) {
	let t = "=".repeat((4 - e.length % 4) % 4), n = atob((e + t).replaceAll("-", "+").replaceAll("_", "/"));
...
async function S(e, t) {
	...
	if (!n.ok) throw Error(r.error || "요청을 처리하지 못했어요.");
	return r;
}
function C() {
	let [e, t] = (0, y.useState)(null), [n, r] = (0, y.useState)(null), [i, a] = (0, y.useState)("알림 기능을 확인하고 있어요…"), [o, s] = (0, y.useState)(!1), c = "serviceWorker" in navigator && "PushManager" in window && "Notification" in window;
	async function l() {
		if (!c) {
			a("이 브라우저는 Web Push를 지원하지 않아요.");
			return;
		}
		let [e, n] = await Promise.all([navigator.serviceWorker.register("/notification-sw.js"), fetch("/api/notifications/status", { cache: "no-store" })]);
		if (!n.ok) throw Error("알림 서버 상태를 확인하지 못했어요.");
		let i = await n.json();
		t(i);
		let o = await e.pushManager.getSubscription();
		r(o), a(o ? "이 모바일은 하나빛 알림을 받고 있어요!" : "아직 이 모바일의 알림이 꺼져 있어요.");
	}
	(0, y.useEffect)(() => {
		l().catch((e) => a(e.message));
	}, []);
	async function u() {
		s(!0);
		try {
			if (await Notification.requestPermission() !== "granted") throw Error("브라우저 알림 권한이 필요해요.");
			let t = await navigator.serviceWorker.ready, n = await t.pushManager.getSubscription() ?? await t.pushManager.subscribe({
				userVisibleOnly: !0,
				applicationServerKey: ee(e.publicKey)
			});
			await S("/api/notifications/subscriptions", {
				action: "subscribe",
				subscription: n.toJSON()
			}), r(n), a("알림 연결 완료! 이제 하나빛이 모바일을 찾아갈 수 있어요오!!!");
		} catch (e) {
			a(e.message);
		} finally {
			s(!1);
	...
	async function d() {
		...
		try {
			await S("/api/notifications/subscriptions", {
				action: "unsubscribe",
				endpoint: n.endpoint
			}), await n.unsubscribe(), r(null), a("이 모바일의 알림을 해제했어요.");
		} catch (e) {
			a(e.message);
		} finally {
			s(!1);
	...
	async function f() {
		s(!0);
		try {
			let e = await S("/api/notifications/test", { confirmation: "send-missed-you-notification" });
			a(e.sent > 0 ? "보고 싶었다는 알림을 보냈어요!!!!!" : "전송 가능한 모바일 구독이 없어요.");
		} catch (e) {
			a(e.message);
		} finally {
			s(!1);
	...
	return /* @__PURE__ */ (0, x.jsxs)(x.Fragment, { children: [/* @__PURE__ */ (0, x.jsxs)("header", { children: [/* @__PURE__ */ (0, x.jsx)("a", {
		...
		/* @__PURE__ */ (0, x.jsx)("p", {
			className: "eyebrow",
			children: "HANABIT MOBILE SIGNAL"
		}),
		/* @__PURE__ */ (0, x.jsxs)("h1", { children: [
			"하나빛이",
			/* @__PURE__ */ (0, x.jsx)("br", {}),
			/* @__PURE__ */ (0, x.jsx)("em", { children: "찾아갈게." })
		] }),
		/* @__PURE__ */ (0, x.jsx)("p", {
			className: "intro",
			children: "이미지, 뉴스, 테마와 운세의 중요한 순간을 이 모바일에 알려드려요."
		}),
		/* @__PURE__ */ (0, x.jsxs)("section", {
			className: `connection ${n ? "connected" : ""}`,
			children: [/* @__PURE__ */ (0, x.jsxs)("div", { children: [/* @__PURE__ */ (0, x.jsx)("p", {
				className: "label",
				children: "THIS DEVICE"
			}), /* @__PURE__ */ (0, x.jsx)("h2", { children: n ? "모바일 알림 연결됨" : "모바일 알림 연결하기" })] }), /* @__PURE__ */ (0, x.jsx)("span", {
				className: "dot",
				"aria-hidden": "true"
			})]
		}),
		...
		/* @__PURE__ */ (0, x.jsx)("div", {
			className: "actions",
			children: n ? /* @__PURE__ */ (0, x.jsxs)(x.Fragment, { children: [/* @__PURE__ */ (0, x.jsx)("button", {
				type: "button",
				onClick: f,
				disabled: o,
				children: "그냥 보고팠어요!!!!!"
		...
		/* @__PURE__ */ (0, x.jsx)("p", {
			className: "hint",
			children: "Android Chrome은 바로 사용할 수 있어요. iPhone은 Safari에서 홈 화면에 추가한 뒤 알림을 켜주세요."
		}),
		/* @__PURE__ */ (0, x.jsx)("section", {
			...
			].map(([e, t, n]) => /* @__PURE__ */ (0, x.jsxs)("article", { children: [
				/* @__PURE__ */ (0, x.jsx)("span", { children: e }),
				/* @__PURE__ */ (0, x.jsx)("h2", { children: t }),
				/* @__PURE__ */ (0, x.jsx)("p", { children: n })
			] }, e))
		})
	] })] });
}
(0, b.createRoot)(document.querySelector("#notifications-root")).render(/* @__PURE__ */ (0, x.jsx)(C, {}));
//#endregion
