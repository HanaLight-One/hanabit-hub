	...
	function Hc(e, t, n) {
		...
		switch (Bi(t), t.tag) {
			...
			case 19:
				...
				if (a = !!(t.flags & 128), o = r.rendering, o === null) if (a) Vc(r, !1);
				else {
...
var se = [
	{
		id: "action",
		label: "확인 필요",
		matches: (e) => ["pending_review", "translation_failed"].includes(e.workflow.status) || oe(e)
	},
	{
		id: "publish",
		label: "게시 후보",
	...
	return /* @__PURE__ */ (0, x.jsxs)("details", {
		...
		children: [
			...
			e.original.embeds.map((e, t) => /* @__PURE__ */ (0, x.jsxs)("section", {
				className: "embed-box",
				children: [
					e.title && /* @__PURE__ */ (0, x.jsx)("h3", { children: e.title }),
					e.description && /* @__PURE__ */ (0, x.jsx)("p", { children: e.description }),
					e.fields.map((e, t) => /* @__PURE__ */ (0, x.jsxs)("div", {
						className: "embed-field",
						children: [e.name && /* @__PURE__ */ (0, x.jsx)("strong", { children: e.name }), e.value && /* @__PURE__ */ (0, x.jsx)("span", { children: e.value })]
					}, `${e.name}-${t}`))
				]
			}, `${e.url ?? "embed"}-${t}`)),
...
function T(e) {
	...
	return t ? oe(e) ? "모델은 이미지 픽셀을 보지 않았어요. 텍스트만으로 내린 보류를 확정하지 말고 이미지와 원문 관계를 사람이 확인하세요." : t.decision === "publish" ? "구체적인 변화가 있는 게시 후보예요. 원문과 이미지를 확인한 뒤 승인하세요." : t.decision === "review" ? "의미 있는 신호일 수 있지만 단정하기 어려워요. 부모 글과 작성자 맥락을 사람이 확인하는 편이 좋아요." : "현재 정보만으로는 뉴스 가치가 낮아 보류를 권해요. 이미지에 핵심 정보가 보일 때만 다시 검토하세요." : "번역과 판정이 끝난 뒤 게시 조언을 확인할 수 있어요.";
}
function E({ triage: e, label: t, advice: n, className: r = "" }) {
	return /* @__PURE__ */ (0, x.jsxs)("section", {
		className: `triage-box ${r}`.trim(),
		children: [
			/* @__PURE__ */ (0, x.jsxs)("div", { children: [/* @__PURE__ */ (0, x.jsx)("span", { children: t }), /* @__PURE__ */ (0, x.jsx)("strong", { children: S[e.decision] })] }),
			/* @__PURE__ */ (0, x.jsxs)("dl", { children: [/* @__PURE__ */ (0, x.jsxs)("div", { children: [/* @__PURE__ */ (0, x.jsx)("dt", { children: "산정 근거" }), /* @__PURE__ */ (0, x.jsx)("dd", { children: e.reason })] }), /* @__PURE__ */ (0, x.jsxs)("div", { children: [/* @__PURE__ */ (0, x.jsx)("dt", { children: "하나빛 조언" }), /* @__PURE__ */ (0, x.jsx)("dd", { children: n })] })] }),
			/* @__PURE__ */ (0, x.jsxs)("small", { children: [
				"신뢰도 ",
				Math.round(e.confidence * 100),
				"%",
				e.importance && ` · 중요도 ${C[e.importance]}`,
				e.evidenceTag && ` · 정보 성격 [${te[e.evidenceTag]}]`,
				e.boardCategory && ` · 게시 분류 ${ne[e.boardCategory]}`
			] })
		]
	});
}
function de({ profile: e }) {
...
function pe({ gate: e }) {
	return e ? /* @__PURE__ */ (0, x.jsxs)("section", {
		...
		children: [
			/* @__PURE__ */ (0, x.jsxs)("div", { children: [/* @__PURE__ */ (0, x.jsx)("span", { children: "AUTO PUBLISH GATE" }), /* @__PURE__ */ (0, x.jsx)("strong", { children: re[e.decision] })] }),
			/* @__PURE__ */ (0, x.jsx)("p", { children: e.reason }),
			e.decision === "eligible" && /* @__PURE__ */ (0, x.jsx)("small", { children: "현재는 판정만 표시하며 실제 DC 자동 게시는 꺼져 있어요." })
		]
	}) : null;
}
function me({ shadow: e }) {
	return e ? /* @__PURE__ */ (0, x.jsxs)("section", {
...
function O({ item: e, preview: t, busy: n, error: r, onPreview: i, onPublish: a, onNoteChange: o, onNoteSave: s, onConfirmAbsent: c }) {
	return e.workflow.publishedToDc ? /* @__PURE__ */ (0, x.jsxs)("div", {
		...
		children: [
			/* @__PURE__ */ (0, x.jsx)("strong", { children: "게시 결과를 자동으로 확정하지 못했어요." }),
			/* @__PURE__ */ (0, x.jsx)("span", { children: "중복 게시를 막기 위해 다시 제출하지 않습니다. DC 게시판에서 직접 확인해 주세요." }),
			/* @__PURE__ */ (0, x.jsx)("button", {
				type: "button",
				className: "preview-button",
				onClick: c,
				disabled: n,
				children: n ? "확인 내용을 저장하는 중…" : "DC에 게시물 없음 · 수동 게시 다시 열기"
			})
		]
...
function he({ item: e, preview: t, busy: n, error: r, onPreview: i, onPublish: a, onNoteChange: o, onNoteSave: s, onConfirmAbsent: c, onRetry: l, onReanalyze: u }) {
	let d = e.workflow.triage, f = e.workflow.freeTriage, p = e.workflow.codexReview, m = e.workflow.status === "shadow_radar";
		...
		children: [
			/* @__PURE__ */ (0, x.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, x.jsxs)("div", {
					...
					children: [
						...
						d && /* @__PURE__ */ (0, x.jsx)("span", {
							className: `decision decision-${d.decision}`,
							children: S[d.decision]
						}),
						d?.evidenceTag && /* @__PURE__ */ (0, x.jsxs)("span", {
							className: `evidence evidence-${d.evidenceTag}`,
							children: [
								"[",
								te[d.evidenceTag],
								"]"
						...
						p?.status === "complete" && /* @__PURE__ */ (0, x.jsx)("span", {
							className: "decision codex-badge",
							children: "Codex 검토 완료"
						})
					]
				}), /* @__PURE__ */ (0, x.jsx)("time", { children: ce(e.source.publishedAt) })]
			}),
			(e.source.label || e.source.account) && /* @__PURE__ */ (0, x.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, x.jsxs)("p", {
					...
					children: [
						...
						" · ",
						e.source.type === "x-post" ? "X" : m ? "외신 RSS" : "Discord"
					]
			...
			m ? /* @__PURE__ */ (0, x.jsxs)("section", {
				...
				children: [
					...
					/* @__PURE__ */ (0, x.jsxs)("h2", { children: [d?.evidenceTag && `[${te[d.evidenceTag]}] `, e.workflow.translation.title || "제목 없음"] }),
				...
				children: [
					...
					e.workflow.analysisFailure && /* @__PURE__ */ (0, x.jsxs)("div", {
						...
						children: [
							...
							e.workflow.analysisFailure.code === "provider_error" && /* @__PURE__ */ (0, x.jsx)("small", { children: ae[e.workflow.analysisFailure.providerReason] ?? ae.unknown }),
							r && /* @__PURE__ */ (0, x.jsx)("span", {
								className: "action-error",
								children: r
							}),
			...
			/* @__PURE__ */ (0, x.jsx)(fe, { item: e }),
			f && /* @__PURE__ */ (0, x.jsx)(E, {
				triage: f,
				label: "무료 API 1차 판정",
				advice: f.advice || "애매함을 감지해 Codex 하나빛에게 전달했어요.",
			...
			d && /* @__PURE__ */ (0, x.jsx)(E, {
				triage: d,
				label: p?.status === "complete" ? "Codex 하나빛 심층검토" : "무료 API 판정",
				advice: oe(e) ? T(e) : d.advice || T(e),
				className: p?.status === "complete" ? "codex-triage" : ""
			}),
			p?.status === "daily_limit" && /* @__PURE__ */ (0, x.jsx)("p", {
				className: "codex-review-note",
				children: "오늘의 Codex 심층검토 상한에 도달해 사람 확인으로 남겼어요."
			}),
			p?.status === "failed" && /* @__PURE__ */ (0, x.jsx)("p", {
				className: "codex-review-note",
				children: "Codex 심층검토를 완료하지 못해 무료 API 판정을 보존했어요."
			}),
			!m && /* @__PURE__ */ (0, x.jsx)(pe, { gate: e.workflow.autoPublishGate }),
			!m && /* @__PURE__ */ (0, x.jsx)(me, { shadow: e.workflow.editorialShadow }),
			...
			e.media.length > 0 && /* @__PURE__ */ (0, x.jsxs)(x.Fragment, { children: [oe(e) && /* @__PURE__ */ (0, x.jsx)("p", {
...
function ge() {
	...
	async function ee(e) {
		let t = i[e.id];
		if (!t?.noteDirty) return t;
		let n = await fetch(`/api/news/${e.id}/dc-editor-note`, {
			method: "POST",
		...
		if (!n.ok) throw Error(r.error || "덧붙일 말을 저장하지 못했어요.");
		let o = m(r);
		return a((t) => ({
			...t,
			[e.id]: o
	...
	async function C(e) {
		if (window.confirm("이 원고를 실제 DCInside 챗갤에 한 번 게시할까요?\n제출 결과가 불명확하면 자동으로 다시 시도하지 않습니다.")) {
			...
			try {
				...
				let r = await fetch(`/api/news/${e.id}/dc-publication`, {
					method: "POST",
					headers: { "content-type": "application/json" },
					body: JSON.stringify({ confirmation: "publish-news-to-dc-now" })
				}), i = await r.json();
				if (!r.ok) throw Error(i.error || "DC 게시 요청을 완료하지 못했어요.");
				await h();
				let o = await fetch(`/api/news/${e.id}/dc-preview`, { cache: "no-store" });
				if (o.ok) {
					let t = await o.json();
					a((n) => ({
						...n,
				...
				if (i.publication?.status === "failed-preflight") throw Error("DC 로그인·말머리·금칙어 검사 단계에서 게시가 중단됐어요. 원고를 확인한 뒤 다시 시도할 수 있어요.");
			} catch (t) {
				l(t.message), d(e.id), await h().catch(() => {});
			} finally {
				s(null);
			}
		}
	...
	async function te(e) {
		if (window.confirm("DC 게시판에서 이 글이 실제로 없음을 확인했나요?\n이전 제출 자료는 보존하고 수동 게시 버튼만 다시 엽니다.")) {
			s(e.id), l(""), d(null);
			try {
				let t = await fetch(`/api/news/${e.id}/dc-ambiguity-resolution`, {
					method: "POST",
					headers: { "content-type": "application/json" },
					body: JSON.stringify({ confirmation: "confirm-dc-post-absent" })
				}), n = await t.json();
				if (!t.ok) throw Error(n.error || "게시 잠금을 다시 열지 못했어요.");
				a((t) => {
					let n = { ...t };
	...
	async function re(e) {
		if (window.confirm("번역과 판정을 새 정책으로 다시 실행할까요? 무료 API와 필요한 경우 Codex 토큰을 사용합니다.")) {
			s(e.id), l(""), d(null);
			try {
				let t = await fetch(`/api/news/${e.id}/reanalysis`, {
					method: "POST",
					headers: { "content-type": "application/json" },
					body: JSON.stringify({ confirmation: "reclassify-news-item" })
				}), n = await t.json();
				if (!t.ok) throw Error(n.error || "새 정책으로 다시 판정하지 못했어요.");
				await h();
			} catch (t) {
				l(t.message), d(e.id);
			} finally {
	...
	return /* @__PURE__ */ (0, x.jsxs)(x.Fragment, { children: [/* @__PURE__ */ (0, x.jsxs)("header", { children: [/* @__PURE__ */ (0, x.jsx)("a", {
		href: "/",
		children: "← 허브 홈"
	}), /* @__PURE__ */ (0, x.jsx)("span", { children: "OWNER ONLY" })] }), /* @__PURE__ */ (0, x.jsxs)("main", { children: [
		/* @__PURE__ */ (0, x.jsx)("p", {
			className: "eyebrow",
			children: "HANABIT NEWS LAB · REACT PILOT"
		}),
		/* @__PURE__ */ (0, x.jsxs)("h1", { children: [
			"뉴스",
			/* @__PURE__ */ (0, x.jsx)("br", {}),
			/* @__PURE__ */ (0, x.jsx)("em", { children: "검수실." })
		] }),
		/* @__PURE__ */ (0, x.jsx)("p", {
			className: "intro",
		...
		/* @__PURE__ */ (0, x.jsxs)("section", {
			...
			"aria-label": "뉴스 현황",
			children: [
				/* @__PURE__ */ (0, x.jsxs)("div", { children: [/* @__PURE__ */ (0, x.jsx)("strong", { children: g.total.toLocaleString("ko-KR") }), /* @__PURE__ */ (0, x.jsx)("span", { children: "전체 대기" })] }),
				/* @__PURE__ */ (0, x.jsxs)("div", { children: [/* @__PURE__ */ (0, x.jsx)("strong", { children: g.review.toLocaleString("ko-KR") }), /* @__PURE__ */ (0, x.jsx)("span", { children: "승인 가능" })] }),
				/* @__PURE__ */ (0, x.jsxs)("div", { children: [/* @__PURE__ */ (0, x.jsx)("strong", { children: g.approved.toLocaleString("ko-KR") }), /* @__PURE__ */ (0, x.jsx)("span", { children: "승인 완료" })] }),
				/* @__PURE__ */ (0, x.jsxs)("div", { children: [/* @__PURE__ */ (0, x.jsx)("strong", { children: g.media.toLocaleString("ko-KR") }), /* @__PURE__ */ (0, x.jsx)("span", { children: "보존 이미지" })] }),
				/* @__PURE__ */ (0, x.jsxs)("div", { children: [/* @__PURE__ */ (0, x.jsx)("strong", { children: g.shadow.toLocaleString("ko-KR") }), /* @__PURE__ */ (0, x.jsx)("span", { children: "외신 그림자" })] })
			]
		}),
		...
		!e && /* @__PURE__ */ (0, x.jsx)("p", {
			className: "notice",
			role: "status",
			children: n || "대기함을 확인하고 있어요…"
		}),
		e?.items.length === 0 && /* @__PURE__ */ (0, x.jsx)("p", {
			className: "notice",
			children: "아직 수집된 뉴스가 없어요. 새 소식을 기다리는 중이에요."
		}),
		e?.items.length > 0 && _.length === 0 && /* @__PURE__ */ (0, x.jsx)("p", {
			className: "notice",
		...
		/* @__PURE__ */ (0, x.jsx)("section", {
			className: "news-list",
			"aria-label": "수집된 뉴스",
			children: _.map((e) => /* @__PURE__ */ (0, x.jsx)(he, {
				item: e,
				preview: i[e.id],
				busy: o === e.id,
				error: u === e.id ? c : "",
				onPreview: () => v(e),
				onPublish: () => C(e),
				onNoteChange: (t) => b(e, t),
				onNoteSave: () => S(e),
				onConfirmAbsent: () => te(e),
				onRetry: () => ne(e),
				onReanalyze: () => re(e)
			}, e.id))
		})
...
(0, b.createRoot)(document.querySelector("#news-root")).render(/* @__PURE__ */ (0, x.jsx)(ge, {}));
//#endregion
