...
const OUTPUT_SCHEMA = Object.freeze({
  ...
  properties: {
    ...
    publicHeadline: { type: "string", minLength: 1, maxLength: 50 },
...
function validateResult(value, contextCount) {
  ...
  return Object.freeze({
    ...
    publicHeadline: limited(value.publicHeadline ?? value.translationAudit?.title, 50, "Codex 게시 제목"),
    decision,
    confidence,
    importance,
    evidenceTag,
...
function buildPrompt(record, freeResult) {
  ...
  return [
    ...
    "publicHeadline is the separate Korean community-post headline. It may use the full SOURCE plus CONTEXT evidence package, must be at most 50 characters, must remain grammatically complete, and must not end mid-phrase or with a dangling particle. Attribute a linked person's claim as context instead of making SOURCE appear to have said it.",
